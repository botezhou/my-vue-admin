<template>
  <div class="components-container p20">
    <code>
      <a class="link-type" href="https://github.com/PanJiaChen/vue-countTo" target="_blank">vue-count-to</a>
      是一个无依赖，轻量级的vue组件，可以自行覆盖easingFn。你可以设置startVal和endVal，它会自动判断计数或倒计时。它支持vue-ssr。它是从countUp.js学到的;
    </code>
    <count-to
      ref="example"
      :start-val="_startVal"
